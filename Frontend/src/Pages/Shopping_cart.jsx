    ...
    <div className="w-[100vw] h-[max-content] flex flex-col lg:gap-[38px] md:gap-6 gap-4 xl:px-20 lg:p-8 p-3">
        ...
        <section className="w-full min-h-[550px] h-[max-content] block lg:flex justify-between px-0">
            { cartItems && cartItems.length > 0 ? 
                ...
                : 
                <div className="xl:w-[829px] lg:w-[680px] w-full h-[16rem] flex justify-center items-center font-Urbanist font-normal text-[var(---neutral)] xl:text-[18px] lg:text-[14px] text-[12px]">No item in cart</div>
            }
            <form id="submit" name="submit" className="xl:w-[395px] lg:w-[260px] md:w-[280px] w-full xl:h-[468px] lg:h-[380px] h-[280px] border-[1px] xl:p-8 lg:p-4 p-2 flex flex-col xl:gap-6 lg:gap-3 gap-1">
                ...
                <button className="w-full xl:h-[60px] lg:h-[50px] h-[40px] font-bold flex justify-center items-center text-white bg-[#F24810] border-[1px] rounded-sm hover:bg-white hover:text-[#F24810] cursor-pointer border-[#F24810] xl:text-xl lg:text-[16px] text-[14px]" onClick={() => handleProceedToCheckout()}>Proceed To Checkout</button>
            </form>
        </section>
    </div>
  )
